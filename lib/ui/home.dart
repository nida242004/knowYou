...
import 'package:breathescape/common/colors.dart';  // Adjusted to reflect app name
import 'package:breathescape/common/constants.dart';  // Adjusted to reflect app name
import 'package:breathescape/ui/detail.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/all_sections_layout.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/app_bar_delegate.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/section_card.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/snapping_scroll_physics.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/statusbar_padding_sliver.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/sections.dart';  // Adjusted to reflect app name
import 'package:breathescape/widgets/section_detail.dart';  // Adjusted to reflect app name
...
class _AnimationDemoHomeState extends State<AnimationDemoHome> {
  ...
  _sharer() {
    Share.share(" YOU - What internet knows about you\n" +
        "https://play.google.com/store/apps/xyz.abc");
  }
    ...
    return Drawer(
      child: Column(
        ...
        children: <Widget>[
          ...
          _divider,
          ListTile(
            leading: const Icon(Icons.settings_input_antenna, color: Colors.black),
            title: const Text(
              "Your   Location",
